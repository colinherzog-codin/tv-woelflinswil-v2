...
export const HighImpactHero: React.FC<Page['hero']> = ({ links, media, richText }) => {
  return (
    <div className="relative -mt-[10.4rem] flex items-end justify-center text-white min-h-[60vh] max-h-[80vh]" data-theme="dark">
      <div
      ...
      <div className="min-h-[60vh] max-h-[80vh] select-none">
